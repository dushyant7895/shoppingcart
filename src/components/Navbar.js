        ...
        <div className='flex items-center font-medium text-slate-100 space-x-6 '>
          ...
          <NavLink to='/cart'>
            <div className='relative'>
              ...
              {
                cart.length > 0 && <span className='absolute -top-2 -right-3 bg-green-600 
